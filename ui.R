shinyUI(navbarPage("HealthMap",
                   tabPanel("App",
                            fluidPage(
                              ...
                              fluidRow(
                                column(4,
                                       sliderInput('year', 'Map Year',min=2010, max=2012, value=2012, 
                                                   step=1, sep='')
                                ),
                                column(4,
                                       h5("Legend:",{img(src="legend2.png", width="400em")})
                                )
                              ),
                              fluidRow(
                                column(4, 
